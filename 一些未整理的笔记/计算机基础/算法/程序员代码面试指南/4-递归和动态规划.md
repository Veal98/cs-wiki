...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210526170327.png)

`dp[i][j] = Math.min(dp[i-1][j], dp[i][j-1]) + m[i][j]`

<img src="https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210526173429.png" style="zoom:67%;" />
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210526175716.png)
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210523170605.png)

> （1 x 2 的矩阵）=（1 x 2 的矩阵）X（2 x 2 的矩阵）

把 F(1)==1, F(2)==1, F(3)==2, F(4)==3 代入，求出状态矩阵：

![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210523170643.png)
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210523170742.png)
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210525124727.png)
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210525130514.png)
...
<img src="https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210618223136.png" style="zoom: 60%;" />
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210602222123.png)

![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210602222240.png)
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210607153342.png)
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210603214818.png)
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210628221132.png)
...
<img src="https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210608230813.png" style="zoom: 50%;" />

<img src="https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210608230830.png" style="zoom:50%;" />

上图的例子可以看下图帮助理解：

![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210608232608.png)
...
<img src="https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210529222145.png" style="zoom:67%;" />
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210529222446.png)
...
<img src="https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210615230521.png" style="zoom:50%;" />
...
![](https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210531214530.png)
...
- 如果 **str1[i-1] ! = str2[j-1]**。先把 str1[0..i-1] 中 str1[0..i-2] 的部分变成 str2[0..j-2]，然后把字符 str1[i-1]替换成 str2[j-1]，这样 str1[0..i-1]就编辑成str2[0..j-1]了。`dp[i-1][j-1]` 表示str1[0..i-2]编辑成str2[0..i-2]的最小代价，那么`dp[i][j]` 可能等于 `dp[i-1][j-1]+rc`。
  ...
  <img src="https://cs-wiki.oss-cn-shanghai.aliyuncs.com/img/20210610211345.png" style="zoom:50%;" />
