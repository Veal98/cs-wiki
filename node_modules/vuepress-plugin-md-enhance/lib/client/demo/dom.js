...
const getCodepenButton = ({ html, js, css, jsLib, cssLib, codepenEditors, codepenLayout }, codeType) => h("form", {
...
export const initDom = ({ code, codeType, container, innerHTML = false, }) => {
    const { id } = container;
    ...
    if (code.isLegal) {
        ...
        if (code.jsfiddle !== false)
            footer.appendChild(getJsfiddleBtn(code));
        if (code.codepen !== false)
